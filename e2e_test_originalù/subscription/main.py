...
def create_table_subscription():
    execute_slt("./e2e_test_originalù/subscription/create_table_and_subscription.slt")

def drop_table_subscription():
    execute_slt("./e2e_test_originalù/subscription/drop_table_and_subscription.slt")
